...
uniform sampler2D RenderedTexture; //rendered scene sampler
uniform float RenderedTextureWidth; //scene sampler width
uniform float RenderedTextureHeight; //scene sampler height
uniform float timer;
