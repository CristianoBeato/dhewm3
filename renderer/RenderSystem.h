...
typedef struct glconfig_s {
	...
	float				glSlVersion; //NMS : GLSL HW SUported Ver
	...
	//if have a valid GLSL Suport
	bool				GLSLAvailable;
	//Maximum number of vertex attributes
	int					maxVertexAttribs;


	//If Available framebuffer for Post fx
	bool				framebufferAvailable;
	bool				framebufferArbAvailable;
	int					maxColorAttachments;

	//If The Hardware suport Tessellation
	bool				tessellationAvailable;

	//enable suport of GLEW debug
	bool				debugOutputAvailable;

	bool				directStateAccess;

	//suport  for sRGB texture and frame buffer istead linear color
	bool				sRGBTextureAvailable;
