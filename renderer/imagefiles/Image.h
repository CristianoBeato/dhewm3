...
#define NMS_SRGB_SUPORT 1
#define NMS_FRAME_BUFFER_TEXTURE 0 
...
typedef enum {
	...
	,
	TD_FRAME_BUFFER_LOW,	//RGB16F
	TD_FRAME_BUFFER_HIGH	//RGB32F
#endif
...
public:
	...
	//NMS Begin //Post FX Textures
#if NMS_FRAME_BUFFER_TEXTURE
	idImage	*			FirstPostFXPASS_COLOR;
	idImage	*			FirstPostFXPASS_NORMAL;
	idImage	*			FirstPostFXPASS_SPECULAR;
#endif
	//NMS End
