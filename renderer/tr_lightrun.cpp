...
void R_DeriveLightData( idRenderLightLocal *light ) {
	...
	if ( !light->lightShader ) {
		if ( light->parms.pointLight ) {
			light->lightShader = declManager->FindMaterial( "textures/lights/defaultPointLight" );
		} else {
			light->lightShader = declManager->FindMaterial( "textures/lights/defaultProjectedLight" );
		}
	}
