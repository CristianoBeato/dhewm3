...
#include "renderer/imagefiles/MegaTexture.h"
#include "renderer/model/ModelDecal.h"
#include "renderer/model/ModelOverlay.h"
...
typedef struct {
	...
	bool					SquareSurfaceIsBound;
	srfTriangles_t*			unitSquareSurface;
	//NMS End
...
extern idCVar r_GLSLVer;
extern idCVar r_useRimLight;
extern idCVar r_useHalfLambert;
extern idCVar r_displayGLSLCompilerMessages;
extern idCVar r_skipMaterialMask;
/*NMS End*/
