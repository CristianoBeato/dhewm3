...
bool DialogScriptEditor::OnInit()
{
	DialogScriptFrame *Mainframe = new DialogScriptFrame("Hello World", wxPoint(50, 50), wxSize(450, 340));
	Mainframe->Show(true);
	return true;
}

DialogScriptFrame::DialogScriptFrame(const wxString& title, const wxPoint& pos, const wxSize& size) : wxFrame(NULL, wxID_ANY, title, pos, size)
{
