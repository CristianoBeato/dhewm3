...
bool GLimp_Init(glimpParms_t parms) {
	...
	//NMS Begin: use GLEW instead QGL
	...
	if (glewInit() != GLEW_OK)
		common->FatalError("Failed to initialize GLEW");
	else
		common->Printf("Using GLEW %s\n", glewGetString(GLEW_VERSION));

	if (!GLEW_VERSION_3_3)
		common->Warning("NO OpenGL 3.3 FOUND, Running in compatybility mode");
	//NMS End
...
#if 0 //no more in use whe use GLEW now
/*
===================
